...
def main():
    ...
    req = requests.get("http://129.7.44.143/bluescale/ecg_waveform.php?id=%s&ts=%s"% (str(patient_id),str(timestamp_id)),auth=('sharan','bluescale'))
    print (req.text)
    ...
    #WAVEFORM PLOT
    #pl.plot(range(0,waveform.size),waveform)
    #pl.show()
